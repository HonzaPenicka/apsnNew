...
export default function HomeContent({ isActive }: { isActive?: boolean }) {
  ...
  return (
    <div ref={containerRef} className="flex flex-col w-screen h-[100dvh] gap-8 bg-black/20 px-4 md:px-8 lg:px-16">
      <Navbar />
      <div className="flex flex-col items-center justify-center shadow-2xl text-center">
        <div className="py-12 md:px-36 md:py-24 gap-8 flex flex-col bg-[#28456C]/40 p-4">
          <h1 
            data-animate
