    ...
    <div className="bg-black/30 px-4 md:px-8 lg:px-16 h-screen">
      <div className="grid md:grid-cols-3 gap-4 overflow-y-auto">
        <div className="flex flex-col gap-8 px-8 py-12 hover:bg-yellow-600/50">
          ...
          <div>Strategicky rozdělujeme projekt - po částech nebo jako celek</div>
        ...
        <div className="flex flex-col gap-8 px-8 py-12 hover:bg-yellow-600/50">
          ...
          <div>Zajistíme Vám marketingový, právní a administrativní outsourcing Našeho realitního oddělení.</div>
          <div>
            ...
            <ol className="list-decimal list-inside mt-4">
              ...
              <li>Získáte reálné nabídky bez čekání (z naší interní sítě klientů)</li>
            </ol>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 px-8 py-12 hover:bg-yellow-600/50">
          ...
          <div>Každý chce chytře investovat do bytových domů se stabilním výnosem – my víme, jak to proměnit ve skutečnost.</div>
